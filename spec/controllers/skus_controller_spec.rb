...
describe SkusController do
  ...
  let(:valid_attributes) { { "item_tbl_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sku as @sku" do
        ...
        post :create, {:sku => { "item_tbl_id" => "invalid value" }}, valid_session
        assigns(:sku).should be_a_new(Sku)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sku" do
        ...
        Sku.any_instance.should_receive(:update).with({ "item_tbl_id" => "MyString" })
        put :update, {:id => sku.to_param, :sku => { "item_tbl_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sku as @sku" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sku.any_instance.stub(:save).and_return(false)
        put :update, {:id => sku.to_param, :sku => { "item_tbl_id" => "invalid value" }}, valid_session
        assigns(:sku).should eq(sku)
      end
